...
<?php
	...
	function new_header($name="Csci 387 Group 8", $urlLink="OMSuserhome.php") {
		echo "<head>";
		...
		echo "<li class='name'>";
		echo "  <h1 align='left'><a href='/~group8/".$urlLink."'>$name</a></h1>";
		echo "</li>";
		echo "</ul>";
		echo "</nav>";
		echo "</div>";
	...
	function new_head($name="Csci 387 Group 8", $urlLink="Admins/OMSadminhome.php") {
		echo "<head>";
		echo "	<title>$name</title>";
		//		<!-- Link to Foundation -->";
		echo "	<link rel='stylesheet' href='css/normalize.css'>";
	...
	function new_logout($name="Csci 387 Group 8", $urlLink="OMSlogout.php") {
		echo "<head>";
		echo "	<title>$name</title>";
		//		<!-- Link to Foundation -->";
		echo "	<link rel='stylesheet' href='css/normalize.css'>";
	...
	function new_admin($name="Csci 387 Group 8", $urlLink="Admins/OMSadminlogout.php") {
		echo "<head>";
		echo "	<title>$name</title>";
		//		<!-- Link to Foundation -->";
		echo "	<link rel='stylesheet' href='css/normalize.css'>";
	...
	function new_footer($name="Csci 387 Group 8"){
	...
	function print_alert($name="Csci 387 Group 8") {
		echo "<br />";
		echo "<div class='row'>";
